...
describe("Category Unit Tests", () => {
  ...
  it("should change name and description", () => {
    ...
    category.changeNameAndDescription({ name: "other name", description: "some description" });
    expect(category.name).toBe("other name");
    expect(category.description).toBe("some description");
    expect(validateSpy).toHaveBeenCalledTimes(2);
  });

  it("should get category by entity_id", () => {
    const category = Category.create({
      name: "Movie",
    });
  ...
  it("should get transform category to json", () => {
    const category = Category.create({
      name: "Movie",
    });
  ...
  it("should inactive and active a category", () => {
    const category = Category.create({
      name: "Movie",
      is_active: false,
    });
